...
- [`KazmierczakHydroModel`](@ref) -- the fast, simplified subglacial hydrology model of
  ...
  see [Water Flux](@ref) for the `psi_out_algorithm` keyword and the trade-off between them. It
  matches that flux to a local conduit scale, and parameterizes the
