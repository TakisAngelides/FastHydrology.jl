...
itself as it moves down the hydraulic gradient (Eq. (3), Sec. 2.2.2 of Kazmierczak et al 2024). The paper drops this term as negligible; we keep it here for generality. We use the unsmoothed
